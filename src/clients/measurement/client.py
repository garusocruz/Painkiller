...
SCHEMA_PATH = Path('/app/src/apps/measurement/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = BinaryPaths.parse_obj({'queryEngine': {'debian-openssl-3.0.x': '/root/.cache/prisma-python/binaries/4.15.0/8fbc245156db7124f997f4cecdd8d1219e360944/node_modules/prisma/query-engine-debian-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    measurement: 'actions.MeasurementActions[models.Measurement]'
    ...
    def __init__(
        ...
        *,
        ...
        self.measurement = actions.MeasurementActions[models.Measurement](self, models.Measurement)
    ...
    def _default_datasource(self) -> DatasourceOverride:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'file:database.measurement_db', 'fromEnvVar': None}).resolve(),
        }
...
class Batch:
    measurement: 'MeasurementBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.measurement = MeasurementBatchActions(self)
