...
from src.apps.patient.utils.uuid import generate_uuid
...
class PatientService:
    ...
    async def create(self, patient: PostPatientSchema) -> PatientModel:
        """Create a Patient

        Returns:
            PatientModel: A proxy to Prisma Models
        """
    ...
    async def read_by_id(self, patient_id: str) -> PatientModel:
        """query a patient according by patient_id

        Args:
            patient_id (str): pk of PatientModel
